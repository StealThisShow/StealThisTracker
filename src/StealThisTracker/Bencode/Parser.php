 ...
 * @subpackage Bencode
 */
class StealThisTracker_Bencode_Parser
{
    protected $pointer;
     ...
     *
     * @throws StealThisTracker_Bencode_Error_Parse In case of parse error.
     * @return StealThisTracker_Bencode_Value_Abstract Parsed value.
     */
    public function parse()
    {
        ...
        while ( $this->pointer < $string_length )
        {
            ...
            {
                throw new StealThisTracker_Bencode_Error_Parse( "Bencode parse error at pointer {$this->pointer}. Unstructured values following each other. Use list/dictionary!", $this->pointer );
            }
            ...
            switch ( $this->string[$this->pointer] )
            {
                ...
                case 'e':
                    ...
                    {
                        throw new StealThisTracker_Bencode_Error_Parse( "Bencode parse error at pointer {$this->pointer}. Unexpected endng.", $this->pointer );
                    }
                    if ( isset( $possible_key ) )
                    {
                        ...
                        throw new StealThisTracker_Bencode_Error_Parse( "Bencode parse error at pointer {$this->pointer}. Incomplete dictionary.", $this->pointer );
                    }
                    ...
                    break;
                default:
                    throw new StealThisTracker_Bencode_Error_Parse( "Bencode parse error at pointer {$this->pointer}. Invalid value.", $this->pointer );
            }
            ...
            if ( 0 != count( $this->container_stack ) && isset( $value ) )
            {
                ...
                if ( $last_container instanceof StealThisTracker_Bencode_Value_List )
                {
            ...
            if ( $value instanceof StealThisTracker_Bencode_Value_Container )
            {
        ...
        if ( 0 != count( $this->container_stack ) )
        {
            throw new StealThisTracker_Bencode_Error_Parse( "Bencode parse error at pointer {$this->pointer}. Unclosed dictionary/list", $this->pointer );
        }
     ...
     *
     * @throws StealThisTracker_Bencode_Error_Parse In case of parse error.
     * @return StealThisTracker_Bencode_Value_Integer
     */
    protected function parseValueInteger()
    {
        ...
        {
            throw new StealThisTracker_Bencode_Error_Parse( "Bencode parse error at pointer {$this->pointer}. Missing ending in integer.", $this->pointer );
        }

        $value = new StealThisTracker_Bencode_Value_Integer( substr( $this->string, ( $this->pointer + 1 ), ( $end_pointer - $this->pointer - 1 ) ) );
     ...
     *
     * @throws StealThisTracker_Bencode_Error_Parse In case of parse error.
     * @return StealThisTracker_Bencode_Value_String
     */
    protected function parseValueString()
    {
        ...
        {
            throw new StealThisTracker_Bencode_Error_Parse( "Bencode parse error at pointer {$this->pointer}. Missing colon in string.", $this->pointer );
        }
        ...
        {
            throw new StealThisTracker_Bencode_Error_Parse( "Bencode parse error at pointer {$this->pointer}. Invalid length definition in string.", $this->pointer );
        }

        $value = new StealThisTracker_Bencode_Value_String( substr( $this->string, ( $colon_pointer + 1 ), $length ) );
     ...
     * values.
     *
     * @return StealThisTracker_Bencode_Value_List
     */
    protected function parseValueList()
    {
        ++$this->pointer;
        return new StealThisTracker_Bencode_Value_List();
    }
     ...
     * upcoming values.
     *
     * @return StealThisTracker_Bencode_Value_Dictionary
     */
    protected function parseValueDictionary()
    {
        ++$this->pointer;
        return new StealThisTracker_Bencode_Value_Dictionary();
    }
}
