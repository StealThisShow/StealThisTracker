 ...
 * @subpackage Bencode
 */
class StealThisTracker_Bencode_Builder
{
    /**
     ...
     * @return StealThisTracker_Bencode_Value_Abstract
     */
    static public function build( $input )
    {
        if ( is_int( $input ) )
        {
            return new StealThisTracker_Bencode_Value_Integer( $input );
        }
        if ( is_string( $input ) )
        {
            return new StealThisTracker_Bencode_Value_String( $input );
        }
        if ( is_array( $input ) )
        {
            ...
            {
                return new StealThisTracker_Bencode_Value_Dictionary( $constructor_input );
            }
            else
            {
                return new StealThisTracker_Bencode_Value_List( $constructor_input );
            }
        }

        throw new StealThisTracker_Bencode_Error_Build( "Invalid input type when building: " . gettype( $input ) );
    }
