 ...
 * @subpackage Seeder
 */
class StealThisTracker_Seeder_Server extends StealThisTracker_Concurrency_Forker
{
    /**
     ...
     *
     * @var StealThisTracker_Seeder_Peer
     */
    protected $peer;
    ...
    public function startChildProcess( $slot )
    {
        ...
        if ( $persistence instanceof StealThisTracker_Persistence_ResetWhenForking )
        {
        ...
        switch( $slot )
        {
            ...
            case 1:
                ...
                break;
            default:
                throw new StealThisTracker_Error( 'Invalid process slot while running seeder server.' );
        }
    }
