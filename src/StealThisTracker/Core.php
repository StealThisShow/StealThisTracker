...
class StealThisTracker_Core
{
     ...
     * @throws StealThisTracker_Error When the announce-list is empty.
     * @return string
     */
    public function createTorrent( $file_path, $size_piece = 262144, $basename = null )
    {
        $torrent = new StealThisTracker_Torrent( new StealThisTracker_File_File( $file_path ), $size_piece, $file_path, $basename );
        ...
        if ( empty( $announce ) )
        {
            throw new StealThisTracker_Error( 'Empty announce list!' );
        }
     ...
     *
     * @param StealThisTracker_Config_Interface $get Config-like representation of the CGI parameters (aka. GET) sent.
     * @return string
     */
    public function announce( StealThisTracker_Config_Interface $get )
    {
        try
        {
            try
            ...
            catch ( StealThisTracker_Config_Error_Missing $e )
            {
            ...
            return StealThisTracker_Bencode_Builder::build( $announce_response );
        }
        catch ( Exception $e )
        {
    ...
    {
        return StealThisTracker_Bencode_Builder::build( array(
