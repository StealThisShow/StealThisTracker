 ...
 * @subpackage File
 */
class StealThisTracker_File_File
{
    /**
     ...
     *
     * @throws StealThisTracker_File_Error_NotExits If the file does not exists.
     * @param string $path
     */
    ...
    public function size()
    {
        ...
        {
            throw new StealThisTracker_File_Error_Unreadable( "File $this is unreadable." );
        }
        return $size;
    }
     ...
     *
     * @throws StealThisTracker_File_Error_Unreadable If the file can't be read.
     * @return resource
     */
     ...
     *
     * @throws StealThisTracker_File_Error_NotExits
     */
    protected function shouldExist()
    {
        if ( !$this->exists() )
        {
            throw new StealThisTracker_File_Error_NotExits( "File $this does not exist." );
        }
    }
}
