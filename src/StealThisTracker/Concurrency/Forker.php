 ...
 */
abstract class StealThisTracker_Concurrency_Forker
{
    /**
    ...
    final public function startDetached()
    {
        ...
        if ( false === $sid )
        {
            throw new StealThisTracker_Concurrency_Error( 'Unable to become session leader (detaching).' );
        }
     ...
     *
     * @throws StealThisTracker_Concurrency_Error When forking is unsuccessful.
     ...
     *
     * @throws StealThisTracker_Concurrency_Error if the forking is unsuccessful.
    ...
    protected function fork()
    {
        ...
        if( -1 == $pid )
        {
            throw new StealThisTracker_Concurrency_Error( 'Unable to fork.' );
        }
