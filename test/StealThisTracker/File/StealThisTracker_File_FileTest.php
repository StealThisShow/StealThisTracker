...
/**
 * Test class for StealThisTracker_File_File.
 */
class StealThisTracker_File_FileTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->object = new StealThisTracker_File_File( $this->original_path );
    }
    ...
    /**
     * @expectedException StealThisTracker_File_Error_NotExits
     */
    public function testNonExistent()
    {
        $non_existent = new StealThisTracker_File_File( sys_get_temp_dir() . '/no_way_this_exists' );
    }
    ...
    /**
     * @expectedException StealThisTracker_File_Error_Unreadable
     */
