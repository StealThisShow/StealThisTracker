...
/**
 * Test class for StealThisTracker_Config_Simple.
 */
class StealThisTracker_Config_SimpleTest extends PHPUnit_Framework_TestCase
{

    /**
     * @var StealThisTracker_Config_Simple
     */
    protected $object;
    ...
    {
        $this->object = new StealThisTracker_Config_Simple( array(
            'key1' => 'value1',
            'key2' => 'value2',
        ) );
    }
    ...
    /**
     * @expectedException StealThisTracker_Config_Error_Missing
     */
