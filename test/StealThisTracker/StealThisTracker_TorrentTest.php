...
/**
 * Test class for StealThisTracker_Torrent.
 */
class StealThisTracker_TorrentTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $file = new StealThisTracker_File_File( $this->file_path );

        $this->object = new StealThisTracker_Torrent( $file, 2 , null, null, null, null, null, array(), array( 'http://example.com/test.ext' ) );
    }
    ...
    public function testCreateTorrentFile()
    {
        ...
        $parser = new StealThisTracker_Bencode_Parser( $bencoded_torrent );
        ...
        $this->assertEquals( $decoded_torrent['url-list'], array( 'http://example.com/test.ext' ) );
    }
    ...
    /**
     * @expectedException StealThisTracker_Error
     */
