...
/**
 * Test class for StealThisTracker_Logger_File.
 */
class StealThisTracker_Logger_FileTest extends PHPUnit_Framework_TestCase
{

    /**
     * @var StealThisTracker_Logger_File
     */
    protected $object;
    ...
    protected function setUp()
    {
        ...
        $this->object = new StealThisTracker_Logger_File( new StealThisTracker_Config_Simple( array(
